...
import { Calculator, FileText, TrendingUp, Clock, Map, Calendar, Newspaper, FileCheck, ScrollText, FileSpreadsheet } from 'lucide-react';
...
const Dashboard = () => {
  ...
  const quickActions = [
    ...
    { path: '/passport-extractor', icon: FileSpreadsheet, title: 'Bulk Passport Extractor', desc: 'Fast OCR & Auto Verify', color: 'bg-primary/10 text-primary' },
